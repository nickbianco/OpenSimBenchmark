...
R"(Benchmark a forward simulation using a semi-explicit Euler integrator.

Usage:
  benchmark_euler <model> <output> --time=<time> --step=<step> --accuracy=<accuracy>
  benchmark_euler -h | --help
...
int main(int argc, char** argv) {
    ...
    SimTK::Vector results = run_benchmarks(model, time, step, accuracy,
            Manager::IntegratorMethod::SemiExplicitEuler2);
