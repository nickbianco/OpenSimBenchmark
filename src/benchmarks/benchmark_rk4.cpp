...
R"(Benchmark a forward simulation using a Runge-Kutta-Merson integrator.

Usage:
  benchmark_rk4 <model> <output> --time=<time> --step=<step> --accuracy=<accuracy>
  benchmark_rk4 -h | --help
...
int main(int argc, char** argv) {
    ...
    SimTK::Vector results = run_benchmarks(model, time, step, accuracy,
            Manager::IntegratorMethod::RungeKuttaMerson);
